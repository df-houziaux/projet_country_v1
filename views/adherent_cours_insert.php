...
<body>
    ...
    <div class="container">
        ...
        <fieldset>
            <form action="../controllers/adherent_cours_insertCTRL.php" method="POST" class="form">
                <div class="titreformulaire">
                    <h1>Insertion d'un cour dans la table adherent cours</h1>
                </div>
                <!-- Champ pour le code postal -->
                <div class="form-element">
                    <label for="id_cours">Cours:</label>
                    <div>
                        <input type="text" name="id_cours" id="id_cours" autofocus value="">
                        <span class=" obligatoire">*</span>
                    </div>
                </div>
                <!-- Champ pour le nom de la ville -->
                <div class="form-element">
                    <label for="id_adherent">Numéro de adherent:</label>
                    <div>
                        <input type="text" name="id_adherent" id="id_adherent" value="">
                        <span class="obligatoire">*</span>
                    </div>
                </div>
